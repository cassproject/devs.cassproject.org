...
$('#index').load('https://docs.google.com/document/d/1a7dZ52wqTRk4ZlS7tNooCHxDa3RZ1g-6RYOBn1503Hw/pub?embedded=true', null, function () {
    $("style").remove();
    $("a").each(function () {
...
if (QueryString["doc"] == null)
    QueryString["doc"] = "1I1aX1efeF0K8QYuui4n1fxnJ19x8rgLl6qjOa3SsUqg";
